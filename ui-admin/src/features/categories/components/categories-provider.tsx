...
import { type Categories } from '../data/schema'
...
type CategoriesContextType = {
  ...
  currentRow: Categories | null
  setCurrentRow: React.Dispatch<React.SetStateAction<Categories | null>>
}
...
export function CategoriesProvider({
  ...
  const [currentRow, setCurrentRow] = useState<Categories | null>(null)
